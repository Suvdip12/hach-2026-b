...
> A robust backend API for CurioTech, a learning platform designed for kids. Built with Node.js, Express, and PostgreSQL with multi-tenancy support.
...
CurioTech Backend is a multi-tenant learning management system designed specifically for educational institutions. It provides a comprehensive API for managing schools, students, instructors, courses, lectures, assignments, and analytics with role-based access control and tenant isolation.
...
```bash
git clone https://github.com/careercafe-in/curiotech-backend.git
cd curiotech-backend
```
...
DATABASE_URL=postgresql://user:password@localhost:5432/curiotech
...
fetch('http://localhost:5000/api/student', {
  credentials: 'include',
  headers: {
    'x-school-domain': 'myschool.curiotech.com'
  }
})
```
...
BETTER_AUTH_URL=https://api.curiotech.com
CLIENT_URL=https://curiotech.com
```
...
BETTER_AUTH_URL=https://api-staging.curiotech.com
CLIENT_URL=https://staging.curiotech.com
```
...
- **Issues**: [GitHub Issues](https://github.com/careercafe-in/curiotech-backend/issues)
- **Repository**: [GitHub](https://github.com/careercafe-in/curiotech-backend)
